...
DATABASES = {
    'default': {
        ...
        'NAME': 'store.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '3iu*#5&amp;8d2e5e-1()yk67tw2fa7d5#l8d)05iww-tsuc-1huf@'
...
store %s</a><ul class='user-options'><li><a href='/' \
